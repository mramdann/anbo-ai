...
Anbo direction, what's shipped, what's coming, and what's deliberately out of scope.

This file is updated as direction evolves. For day-to-day work, see [GitHub Issues](https://github.com/mramdann/anbo-ai/issues) and the Projects board.

## What Anbo is

Anbo is a fast, lightweight, AI-native terminal (ADE - agentic development environment). It pairs a native PTY backend with a modern UI: multi-tab terminals, an integrated code editor, a file explorer, source control, and a first-class AI agent system that works with your own API keys or fully local models. Under 10 MB on disk. No telemetry. Keys stored in the OS keychain.
...
- [ ] AI agent meta-orchestration (Anbo agent spawning and managing external coding agents like Claude Code / OpenCode)
...
Categories that will not be built into Anbo. Individual feature requests in these categories will be closed.
