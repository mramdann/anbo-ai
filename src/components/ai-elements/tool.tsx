...
const TOOL_META: Record<string, { label: string; icon: typeof File01Icon }> = {
  ...
  terminal_wait: { label: "Wait for terminal", icon: TerminalIcon },
  terminal_interrupt: { label: "Interrupt terminal", icon: TerminalIcon },
...
const ToolImpl = ({
  ...
  return (
    ...
    >
      ...
      {hasDetails && (
        <CollapsibleContent
          className={cn("anbo-collapsible-content")}
        >
