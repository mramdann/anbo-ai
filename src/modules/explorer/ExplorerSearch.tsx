...
export const ExplorerSearch = forwardRef<ExplorerSearchHandle, Props>(
  function ExplorerSearch(
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: A successful rename invalidates results without changing the query.
    useEffect(() => {
    ...
    }, [query, rootPath, showHidden, workspace, refreshKey]);
              ...
              onKeyDown={(e) => {
                ...
                if (results.length > 0) {
                  if (e.key === "ArrowDown") {
                    ...
                    e.preventDefault();
                    setRenaming(results[selectedIndex].path);
                  }
                }
              }}
                    ...
                    return (
                      ...
                      >
                        ...
                        <InlineInput
                          ...
                          ariaLabel={
                            hit.is_dir ? "Rename folder" : "Rename file"
                          }
                          errorTitle="Could not rename"
                          onCancel={() => setRenaming(null)}
                          onCommit={async (name) => {
                            const generation = requestGeneration.current;
                            await onRename(hit.path, name);
