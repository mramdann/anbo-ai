...
Anbo is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about Anbo. Take off-topic conversations elsewhere.
...
If you see or experience a violation, contact the [Anbo maintainer](https://github.com/mramdann) privately with subject `[Anbo conduct]`. Include links and context.
